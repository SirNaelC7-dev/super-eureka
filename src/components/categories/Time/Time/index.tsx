...
let medida = 'Tempo';
let definicao = 'Duração relativa das coisas que cria no ser humano a ideia de presente, passado e futuro; período contínuo no qual os eventos se sucedem.';

const medidas = ['', 'Ano', 'Mês', 'Semana', 'Dia', 'Hora', 'Minuto', 'Segundo', 'Milissegundo', 'Microsegundo', 'Nanosegundo '];
